    ...
    @section('content')
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto">
                ...
                @if ($game->status === 'in_progress')
                    <div class="tictactoe-board mt-8" id="game-board">
                        @for ($i = 0; $i < 9; $i++)
                    ...
                    <script>
                        setInterval(function() {
                            fetch("{{ route('games.show', $game) }}")
                                .then(response => response.text())
                                .then(html => {
                                    document.getElementById('game-board').innerHTML = new DOMParser().parseFromString(html, 'text/html').getElementById('game-board').innerHTML;
                                });
                        }, 2000);
                    </script>
                @endif
